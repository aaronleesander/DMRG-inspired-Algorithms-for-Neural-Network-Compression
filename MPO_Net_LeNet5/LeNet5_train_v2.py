...
import MPO_Net_LeNet5.LeNet5_inference_v2 as inference
from MPO_Net_LeNet5.LeNet5_hyperparameter_v2 import *
...
def mnist(inp, r_1, r_2, r_3):
    ...
    y = inference.inference(x, r_1, r_2, r_3)
