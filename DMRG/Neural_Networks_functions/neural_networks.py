...
import Neural_Networks_functions.activation_functions as act
...
def compress_layer_single_dim(raw_state, phys_dim, threshold, compressed_dim):
    """ Initializes a compressed state then sweeps left->right
    ...
    Args:
        ...
        phys_dim: List of physical dimensions by site
        threshold: Difference between sweeps under which a solution is found
        compressed_dim: Original max bond dimension
