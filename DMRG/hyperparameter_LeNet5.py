...
flags.DEFINE_integer('global_step', 1000, 'total step the network to train')
...
#flags.DEFINE_integer('tt_ranks_3',  2, 'ranks of the third tensor train')
